...
def downgrade() -> None:
    op.execute(sa.text("drop table if exists accesses cascade"))
    op.execute(sa.text("drop table if exists users cascade"))
    op.execute(sa.text("drop table if exists access_requests cascade"))
    op.execute(sa.text("drop table if exists errors cascade"))
